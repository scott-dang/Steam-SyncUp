...
export const Modal = ({  onSave, onCancel, modalState, setModalState, modalContent }) => {
    return (
...
export const AlertModal = ({ modalState, setModalState, cancelButtonRef, modalHeader, modalContent }) => {
    return (
        <Transition.Root show={modalState} as={Fragment}>
        <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => setModalState(false)}>
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
            enterFrom="opacity-0"
...
export const NotificationModal = ({ modalState, setModalState, cancelButtonRef, modalHeader, modalContent }) => {
	return (
			<Transition.Root show={modalState} as={Fragment}>
			<Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => setModalState(false)}>
				<Transition.Child
